...
<style type="text/css">
	body { background-image:url(<%=request.getContextPath()%>/resources/pic/bg.jpg);background-position: 40% 0px; ;font-family: "微软雅黑";font-weight: ;font: normal 100% Helvetica, Arial,sans-serif 900;}
...
<body>
	...
	<div class="container">
      <div class="container_1"><img src="<%=request.getContextPath()%>/resources/images/404.png"></div>
      <div class="container_2"><img src="<%=request.getContextPath()%>/resources/images/3.22.gif" ></div>
      <div class="container_3"><!--<img src="images/404_1.png" >-->
         <div class="container_3_1"><span>SORRY你要访问的资源弄丢了</span></div>
	...
	<%--<div class="maincolumn">--%>
	  <%--<div class="maincolumn_bg">--%>
         <%--<ul>--%>
           <%--&lt;%&ndash;<li><a href="http://192.168.31.166/web/page/about/aboutUs">关于我们</a></li>&ndash;%&gt;--%>
           <%--&lt;%&ndash;<li><a href="http://192.168.31.166/web">返回首页</a></li>&ndash;%&gt;--%>
         <%--</ul>--%>
      <%--</div>--%>
	  <%--<div></div>--%>
	<%--</div>--%>
